...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const defaultTitle = "Contact Us for AI & Digital Solutions | SyncOrigins";
  const defaultDesc = "Get in touch with SyncOrigins for expert AI, ERP, and data solutions. Let’s discuss how we can transform your business with tailored strategies.";
